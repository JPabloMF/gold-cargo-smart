...
export const createQuote = async (req, res) => {
  try {
    const { customer, phone, email, annotations, origin, destination, type } = req.body;
    const quote = await Quote.create({ customer, phone, email, annotations, origin, destination, type });
